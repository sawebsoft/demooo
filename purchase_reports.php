  ...
  <body>
    ...
    <div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
        ...
        <span class="breadcrumb-item active">Puschase Report</span>
      </nav>
                ...
                <table id="datatable" class="table table-bordered" style="width: 90%;" align="center">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th class="bg-white">Product Code</th>
                        <th class="bg-white">Invoice Number	</th>
                        <th class="bg-white">Purchase Date</th>
                        <th class="bg-white">Product Rate</th>
                        <th class="bg-white">Total Price</th>
                        <th class="bg-white">Grand Total</th>
                        <th class="bg-white">Paid Ammount</th>
                        <th class="bg-white">Dues Ammount</th>
                      </tr>
                    </thead>
