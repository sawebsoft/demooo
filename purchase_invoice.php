            ...
            <div class="container-sm p-4">
                <div class="row">
                    ...
                    <div class="col-6 p-4 text-end">
                        <?php
                            ...
                            $sql13 = 'SELECT * FROM purchase_short_manages';
                ...
                <div class="row border-top border-dark border-3"">
                    ...
                    <?php
                            ...
                            $sql14 = 'SELECT * FROM suppliers';
                            $result14 = mysqli_query($conn, $sql14);
                            while($rows14 = mysqli_fetch_assoc($result14)){
                                $supplierName = $rows14['supplierName'];
                                $supplierPhone = $rows14['supplierPhone'];
                                $supplierEmail = $rows14['supplierEmail'];
                                $supplierAddress = $rows14['supplierAddress'];
                           }
                        ?>
                        <h1><?php echo ' '. $supplierName; ?></h1>
                        <b>Mobile:</b><?php echo ' '. $supplierPhone; ?><br>
                        <b>Email:</b><?php echo ' '. $supplierEmail; ?><br>
                        <b>Address:</b><?php echo ' '. $supplierAddress; ?>
                    </div>
                </div><br>
                <div class="row border-top border-dark border-3">
