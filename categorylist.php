  ...
  <body>
    ...
    <h4 class="m-t-0 header-title"><b>Catagory Manage</b></h4><br>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-8">
                    <a href="category_add.php"><button class="btn btn-primary" type="submit">+Add New</button></a>
                    </div>
                    <div class="col-4">
                    ...
                    <?php
                      ...
                      <tr>
                        ...
                        <td  style="width:150px;">
                            ...
                            <a href="category_delete.php?id=<?php echo $row['id'];?>" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a>
                          </td>
