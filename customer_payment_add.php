  ...
  <body>
    ...
    <div class="sl-mainpanel">
      ...
      <div class="container mt-3 bg-light">
          <form action="customer_payment_action.php" method="post" class="row g-3 needs-validation p-1 m-1" novalidate>
            <h4 style="color: #2F4F4F">Customer Payment From</h4>
            <div class="col-md-6">
              <label for="validationCustom01" class="form-label">Customer Name</label>
              <input type="text" class="form-control" id="customerName" placeholder="Supplier Name" name="customerName" required>
            </div>
            <div class="col-md-6">
